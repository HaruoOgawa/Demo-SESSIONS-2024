...
layout(binding = 2) uniform FragUniformBuffer{mat4 model;mat4 view;mat4 proj;mat4 lightVPMat;vec4 cameraPos;float whiteRate;float time;float useSlide;float slideRate;} frag_ubo;
